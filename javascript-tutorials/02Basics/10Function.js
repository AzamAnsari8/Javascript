...
// function showMessage() {
//   let message = "Hello, I'm Anas!"; // local variable
//   alert( message );
// }
...
// function showMessage() {
//   userName = "Fahad"; // (1) changed the outer variable
...
// function showMessage() {
//   let userName = "Fahad"; // declare a local variable
...
// function showMessage(name, Gender) { // arguments: from, text
//   alert(name + 'is a hardworking ' + Gender);
// }

// showMessage('Shruti', 'Girl!'); // Ann: Hello! (*)
// showMessage('Shruti', "What's up?"); // Ann: What's up? (**)
...
let additionResult = sum(220, 20);
let substractionResult = sub(220,20);

alert( additionResult ); // 3
alert( substractionResult ); // 3
